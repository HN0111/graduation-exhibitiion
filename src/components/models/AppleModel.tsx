...
export function AppleModel({ speedMultiplier = 1, ...props }: ModelProps) {
  const modelRef = useRef<THREE.Group>(null!);
  const { scene } = useGLTF('https://pub-76928191cc6045f998d59a3641f27efe.r2.dev/Apple.glb');
...
useGLTF.preload('https://pub-76928191cc6045f998d59a3641f27efe.r2.dev/Apple.glb');
